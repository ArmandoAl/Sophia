...
func (r Routes) Handler() http.Handler {
	...
	mux.Handle("/entities", r.Authn(http.HandlerFunc(r.Contexts.Entities)))
	mux.Handle("/entities/pending", r.Authn(http.HandlerFunc(r.Contexts.PendingEntities)))
	mux.Handle("/entities/", r.Authn(http.HandlerFunc(r.Contexts.EntityResource)))
