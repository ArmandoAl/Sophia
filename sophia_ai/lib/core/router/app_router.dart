...
import 'package:sophia_ai/features/entities/presentation/pages/entities_page.dart';
    ...
    return GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          ...
          name: 'entities',
          pageBuilder: (context, state) =>
              _detail(context, state, const EntitiesPage()),
          routes: [
            GoRoute(
              path: ':id',
              name: 'entity-detail',
              pageBuilder: (context, state) => _detail(
                context,
                state,
                EntityDetailPage(id: state.pathParameters['id']!),
              ),
            ),
          ],
        ),
